export const styles = {
	...
	sectionLayout: `mx-auto max-w-[87rem] py-6 px-6 xl:px-14 xl:py-[2.875rem]`,
	...
	h4: 'text-xl xl:text-2xl font-semibold tracking-tight ',
	...
	headerPadding: 'pb-10 xl:pb-16',
	headerPaddingSm: 'pb-8 xl:pb-12',
	subHeaderPadding: 'pb-8 xl:pb-12',
